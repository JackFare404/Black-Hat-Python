...
import threading
import sys
# import getopt D:\PYtest\黑帽子>python netcat.py -t 127.0.0.1 -p 5555
import subprocess
import argparse
import shlex
import textwrap
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Examples:
            ...
            netcat.py -t 192.168.0.1 -p 5555 -l -u=mytext.exe # upload file
            netcat.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\" #execute command
            echo 'ABC' | ./netcat(old).py -t 192.168.0.1 -p 135 # echo text to server port 135
            netcat.py -t 192.168.0.1 -p 5555 # connect to server
        '''))
    parser.add_argument('-c', '--command', action='store_true', help='command shell')
    parser.add_argument('-e', '--execute', help='execute specified command')
    # -t localhost -p 9999 -l -e="dir"
